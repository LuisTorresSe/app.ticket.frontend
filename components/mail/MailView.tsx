        ...
        <div>
            <Card className="p-4 mb-6">
                ...
                <div className="flex space-x-2">
                    ...
                    <Button variant={filter === EmailStatus.NotDeclared ? 'primary' : 'secondary'} onClick={() => handleFilterChange(EmailStatus.NotDeclared)}>No Declarados ({notDeclaredTicketsCount})</Button>
                    <Button variant={filter === EmailStatus.Declared ? 'primary' : 'secondary'} onClick={() => handleFilterChange(EmailStatus.Declared)}>Declarados</Button>
                </div>
            </Card>
